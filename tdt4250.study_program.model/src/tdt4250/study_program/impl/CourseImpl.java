 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.study_program.impl.CourseImpl#getCode <em>Code</em>}</li>
...
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	protected EClass eStaticClass() {
		return Study_programPackage.Literals.COURSE;
	}
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Study_programPackage.COURSE__CODE, oldCode, code));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Study_programPackage.COURSE__NAME, oldName, name));
	}
	...
	public void setSeason(SeasonKind newSeason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Study_programPackage.COURSE__SEASON, oldSeason, season));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Study_programPackage.COURSE__CODE:
				return getCode();
			case Study_programPackage.COURSE__NAME:
				return getName();
